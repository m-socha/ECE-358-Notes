  ...
  \section{Transport Layer}
    ...
    \subsection{TCP Congestion Control}
      ...
      \subsubsection{TCP Throughput}
        ...
        When packet loss is factored in, the average throughput of a connection becomes around $\frac{1.33 \cdot MSS}{RTT \sqrt{L}}$, where $L$ is the packet loss ratio. A key takeaway

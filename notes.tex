...
\begin{document}
  ...
  \section{Introduction - Internet Fundamentals}
    \subsection{What is the Internet?}
      ...
      connected to the Internet are known as hosts (end systems), and are running some kind of network apps.
      ...
      The Internet can also be described from a more service-oriented perspective, since it can be used to provide
